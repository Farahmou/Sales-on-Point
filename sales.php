						  ...
						  ?>
								...
								<div class="row">
									...
									<div class="col-md-8">
									   <div class="mainsec">
										<form action="" method="POST">
										 ...
										 <?php
										  $productcode=''; $productname='';  $price =''; $quantity=''; $total=''; $barcode=''; $quan=''; $decquantity='';
										...
										<?php 
										  ...
										  if(isset($_POST['action'])){
													 ...
													 $sql = "INSERT INTO sales_item(product_code,product_name,price,quantity,amount) VALUES('$productcode',' $productname','  $price ','$quantity',' $total')";
											         $sql1= "UPDATE product SET product_id='$id', product_name='$productname', description='$productdes', catagory='$catname ', warenty='$warranty', price_cost='$costprice ', price_retail='$retailprice', barcode='$barcode ', reorder_level='$reorderevel',	quantity='$decquantity', product_date='$productdate',status='$status' WHERE product_id= $id";
                                                     $result=mysqli_query($conn,$sql); 
								  ...
								  <table class="table table-bordered">
									  ...
									  <?php
										   $proname ='';  $quan =''; $salesid=''; $amount='';
										 $sql=" select * from sales_item order by (	sales_id)" ;
										  $result=mysqli_query($conn,$sql);
									...
									<tbody>
									 <tr>
									  ...
									  <td><a class ="btn btn-danger"  onclick="return confirm('Are You Sure?')" href="salesdelete.php?id= <?php echo $row['sales_id'];?>& names=<?php echo $names;?> "> Delete</a></td>
							...
							<div class="col-md-4">
							 <div class="mainsec">
										<form action="confirmsalesreport.php?names=<?php echo $names;?>" method="POST">
